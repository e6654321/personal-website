      ...
      <div className="max-w-4xl mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-white/60 text-lg">
            Available for new opportunities • 2-4 weeks notice
          </p>
        </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a 
                  ...
                  className="text-white hover:text-[#00D4AA] transition-colors"
                >
                  enespra@gmail.com
                </a>
              </div>
        ...
        <div className="text-center">
          <Button 
            size="lg" 
            className="bg-[#00D4AA] hover:bg-[#00BFA5] text-white font-semibold px-12"
            asChild
          >
