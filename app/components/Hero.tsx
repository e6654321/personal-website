...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* Subdued Background Glow - NO bright gradients */}
      <div className="absolute inset-0 pointer-events-none opacity-30">
        <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-[#3B82F6]/10 rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 left-1/3 w-80 h-80 bg-[#5B8DEF]/10 rounded-full blur-3xl" style={{ animationDelay: '1s' }} />
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        <p className="text-lg text-[#94A3B8] mb-10 max-w-2xl mx-auto leading-relaxed">
          Building scalable web3 platforms, mobile applications, and enterprise systems.
          Specialized in React, React Native, blockchain smart contracts, and cloud architecture.
        </p>
        ...
        <div className="flex gap-4 justify-center flex-wrap">
          <Button 
            size="lg"
            className="bg-[#3B82F6] hover:bg-[#5B8DEF] text-white font-semibold px-8 transition-colors"
        ...
        {/* Social Links */}
        <div className="mt-12 flex gap-6 justify-center text-[#94A3B8]">
          <a 
